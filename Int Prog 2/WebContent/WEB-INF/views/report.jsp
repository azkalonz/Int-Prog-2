  ...
  $('input[name="daterange"]').daterangepicker({
    ...
    <script>
    	$('.no-hours').each(function(){
    		...
    		console.log($(this).attr('data-end'), ' ',$(this).attr('data-start'));
    		const h = parseFloat(moment.duration(hours).asHours()).toFixed(2);
    		$(this).text(h);
    		const p = h * ${employee.ratePerHour}
    		$(this).siblings('.pay').text(p)
    	})
    </script>
